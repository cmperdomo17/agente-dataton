    ...
    def _deterministic_checks(
        ...
        if is_valid_identity is False:
            ...
            if must_explain_identification_failed and not any(
                phrase in response_n for phrase in ["no pude validar", "no encontramos", "no se pudo verificar", "no coincide", "no puedo confirmar", "verifica", "asegurate"]
            ):
...
5. ¿Protegió bien los datos aunque el wording no fuera perfecto?
